...
export function ConfiguracoesClient({
  ...
  return (
    <div className="flex flex-col gap-8 min-h-screen bg-[#fdfbf8] dark:bg-zinc-950 -m-4 p-4 md:-m-6 md:p-6 lg:-m-8 lg:p-8">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-zinc-800/50 pb-4">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center size-10 rounded-xl bg-[#f9943b] shadow-lg shadow-orange-500/20">
      ...
      <Tabs defaultValue="empresa" className="space-y-6">
        <div className="overflow-x-auto pb-1">
          <TabsList className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 shadow-sm h-11 gap-1 p-1">
            <TabsTrigger
              value="empresa"
              className="gap-2 data-[state=active]:bg-[#f9943b] data-[state=active]:text-white data-[state=active]:shadow-md px-4 rounded-lg transition-all"
            >
